...
import {
  ...
  deleteOrder,
  verifyPayment,
} from "../../components/Service/orderService";
import { clearCartItems } from "../../components/Service/cartService";
...
const PlaceOrder = () => {
  ...
  const initiateRazorpayPayment = (order) => {
    const options = {
      ...
      handler: verifyPaymentHandler, // success handler
      prefill: {
    ...
    razorpay.on("payment.failed", function (response) {
      ...
      deleteOrderHandler(order._id); // delete the order on payment failure
      navigate("/");
    });
  ...
  const deleteOrderHandler = async (orderId) => {
    if (!orderId) return; // avoid calling API with undefined
    try {
